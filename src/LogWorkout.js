...
//     if (splitDay !== 'Cardio' && (!weight || !sets || reps.some(rep => !rep))) {
//       setErrorMessage('Please enter weight, sets, and reps for the exercise.');
//       return;
//     }
...
//     const newExercise = {
//       exercise: exerciseToSave,
//       weight: splitDay === 'Cardio' ? '' : weight,
//       sets: splitDay === 'Cardio' ? '' : sets,
//       reps: splitDay === 'Cardio' ? [] : reps,
//       duration: splitDay === 'Cardio' ? duration : '',
//       distance: splitDay === 'Cardio' ? distance : '',
//     };
